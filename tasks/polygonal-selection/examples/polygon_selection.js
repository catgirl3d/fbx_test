...
export class PolygonSelectionManager {
  ...
  activate() {
    ...
    console.log('[PolygonSelection] Activated - Click and drag to create selection polygon');
  }
  ...
  deactivate() {
    ...
    this.clearPolygon();
    console.log('[PolygonSelection] Deactivated');
  }
  ...
  performSelection() {
    if (!this.sceneManager || this.polygonPoints.length < 3) return;
