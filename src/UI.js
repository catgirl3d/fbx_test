...
export function initUI({
  ...
  // Reset / clear buttons
  resetCameraBtn?.addEventListener('click', () => { onFrame && onFrame(); });
  clearSceneBtn?.addEventListener('click', () => { onClearScene && onClearScene(); persistedToast('Сцена очищена'); persist(); });
